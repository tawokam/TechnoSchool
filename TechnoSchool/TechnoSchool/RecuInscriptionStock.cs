...
{
    public partial class RecuInscriptionStock : Form
    {
        // ---------------
        ...
        public class Maxcaisse
        {
            ...
            public void maxcaisse()
            {
                ...
                reader42.Close();
                string montinscript = "";
                string se = "select inscription.session,inscription.reste,inscription.id_classe,inscription.matricule,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,classe.id_classe,classe.nom_classe,inscription.montinscription from inscription inner join eleves on inscription.matricule=eleves.matricule inner join classe on inscription.id_classe=classe.id_classe where inscription.matricule=@matricule AND inscription.session=@session";
        ...
        public RecuInscriptionStock(string recu)
        {
            InitializeComponent();
            connexionDB();
