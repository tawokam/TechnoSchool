...
{
    public partial class Editscolarite : Form
    {
        // ---------------
        ...
        public Editscolarite(string matricule, string session)
        {
            InitializeComponent();
            connexionDB();
        ...
        private void Editscolarite_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void tableaudonnees_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            formodifscolarite modif = new formodifscolarite(recu);
            modif.ShowDialog();
        }
    }
}
