...
{
    public partial class formodifscolarite : Form
    {
        // ---------------
        ...
        // class de modification d'un versement et et modification du montant versé et reste de la table scolarite
        public class Modif
        {
            ...
            public void infoverse()
            {
                ...
                try
                {
                    ...
                    // Séléction de la ligne scolarité et modification de la ligne en question
                    ...
                    while (reader.Read())
                    {
                        ...
                        if (montinscription >= sommcaiss)
                        {
                            ...
                            // Si c'est le cas supprimer la ligne en question dans la table scolarite
                            // Si non modifions la ligne conserné
                            if(sommcaiss == 0)
                            {
                                string supp = "DELETE FROM SCOLARITE WHERE matricule='" + Matricule + "' AND session='" + Session + "'";
                                command = new MySqlCommand(supp, connection2);
                                command.Prepare();
                                command.Transaction = trans2;
                                command.ExecuteNonQuery();
                                // Supprimer le versement encaisse si le nouveau montant est 0
                        ...
                        else
                        {
                            ...
                            string messag = "Le montant versé par l'élève est supérieur au montant de la scolarité";
        ...
        public formodifscolarite(string recu)
        {
            InitializeComponent();
            connexionDB();
        ...
        private void formodifscolarite_Paint(object sender, PaintEventArgs e)
        {
