...
{
    public partial class Listeversementrecuscolarite : Form
    {
        // ---------------
        ...
        public Listeversementrecuscolarite(string matricule, string session)
        {
            InitializeComponent();
            connexionDB();
        ...
        {
            string nom = (tableaudonnees.CurrentRow.Cells["N° reçu"].Value).ToString();
            RecuscolariteStock details = new RecuscolariteStock(nom);
            details.ShowDialog();
        }
    }
}
