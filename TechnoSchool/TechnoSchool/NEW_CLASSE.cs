...
{
    public partial class NEW_CLASSE : Form
    {
        // ---------------
        ...
        public class designDatagridviewSearch
        {
            ...
            // constructeur
            public designDatagridviewSearch(DataGridView tableauDonnees, int idsection, string nomsect)
            {
                this.TableauDonnees = tableauDonnees;
                this.Idsection = idsection; this.Nomsect = nomsect;
            ...
            public void affichDonnees(DataGridView datagridview)
            {
                ...
                datagridview.Columns[3].Name = "Scolarité";
                datagridview.Columns[4].Name = "Section";
                ...
                string requete = "Select classe.id_classe,classe.nom_classe,classe.montscolarite,classe.montinscription,classe.id_section,tabsection.id_section,tabsection.nom_section From classe inner join tabsection on classe.id_section=tabsection.id_section where classe.id_section =@idsect order by classe.nom_classe asc";
            ...
            public void affichDonneesdatagrid(DataGridView datagridview, int numbtn, int nbreligneParPage)
            {
                ...
                datagridview.AllowUserToAddRows = false;
                // couleur des entetes de colonnes
                string requete = "Select classe.id_classe,classe.nom_classe,classe.montscolarite,classe.montinscription,classe.id_section,tabsection.id_section,tabsection.nom_section From classe inner join tabsection on classe.id_section=tabsection.id_section where classe.id_section=@idsect order by classe.nom_classe asc limit " + nbreligneParPage + " offset " + lignedebut + "";
                command = new MySqlCommand(requete, connection);
                Dictionary<string, object> parametre = new Dictionary<string, object>();
                parametre.Add("@idsect", Idsection);
                command = new MySqlCommand(requete, connection);
                ...
                while (reader.Read())
                {
                    datagridview.Rows.Add(number.ToString(), "" + reader.GetValue(1).ToString(), reader.GetValue(3).ToString(), reader.GetValue(2).ToString(), reader.GetValue(6).ToString());
                    number++;
            ...
            public int Compteligne(Label labeltete, Panel numpclob, Label backPage1, Label precedentPage, Label suivantPage, Label dernierPage, Label btnPage1, Label btnPage2, Label btnPage3, Label btnPage4, Label btnPage5, int numPageClick, int nbreLignePage)
            {
                ...
                if (nbrePage <= 1)
                {
                    ...
                    labeltete.Text = "1 / 1 page        " + nbreligne + " classe(s)  enregistré(s)  Section : "+ Nomsect +" ";
                ...
                else
                {
                    ...
                    labeltete.Text = numPageClick + " / " + newNbrePage + " page(s)        " + nbreligne + " classe(s)  enregistré(s)  Section : "+ Nomsect + " ";
        ...
        public class designDatagridview
        {
            ...
            public void affichDonnees(DataGridView datagridview)
            {
                ...
                datagridview.AllowUserToAddRows = false;
                // couleur des entetes de colonnes
                string requete = "Select classe.id_classe,classe.nom_classe,classe.montscolarite,classe.montinscription,classe.id_section,tabsection.id_section,tabsection.nom_section From classe inner join tabsection on classe.id_section=tabsection.id_section order by tabsection.nom_section asc";
                command = new MySqlCommand(requete, connection);
                command.Prepare();
                reader = command.ExecuteReader();
                datagridview.Rows.Clear();
            ...
            public void affichDonneesdatagrid(DataGridView datagridview, int numbtn, int nbreligneParPage)
            {
                ...
                datagridview.AllowUserToAddRows = false;
                // couleur des entetes de colonnes
                string requete = "Select classe.id_classe,classe.nom_classe,classe.montscolarite,classe.montinscription,classe.id_section,tabsection.id_section,tabsection.nom_section From classe inner join tabsection on classe.id_section=tabsection.id_section order by tabsection.nom_section  asc limit " + nbreligneParPage + " offset " + lignedebut + "";
                command = new MySqlCommand(requete, connection);
                command.Prepare();
                reader = command.ExecuteReader();
                datagridview.Rows.Clear();
            ...
            public int Compteligne(Label labeltete, Panel numpclob, Label backPage1, Label precedentPage, Label suivantPage, Label dernierPage, Label btnPage1, Label btnPage2, Label btnPage3, Label btnPage4, Label btnPage5, int numPageClick, int nbreLignePage)
            {
                ...
                {
                    // Une seul page trouvé
                    labeltete.Text = "1 / 1 page        " + nbreligne + " classe(s)  enregistré(s)";
                    numpclob.Visible = false;
                    btnPage1.Visible = false;
                    btnPage2.Visible = false;
                    btnPage3.Visible = false;
                ...
                else
                {
                    ...
                    // Plusieurs pages trouvé
                    numpclob.Visible = true;
                    labeltete.Text = numPageClick + " / " + newNbrePage + " page(s)        " + nbreligne + " classe(s)  enregistré(s)";
                    // remplissage de mon dictionnaire
                    for (int b = 1; b <= newNbrePage; b++)
                    {
                        numPage.Add(b);
        ...
        public class deleteData
        {
            ...
            private void delete()
            {
                ...
                string messagconf = "Souhaitez-vous réellement supprimer la classe " + Nom + " ?. ";
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        connection.Open();
                        int idclasse = 0;
                        // Recuperation de l'id de la classe a partir du nom de la classe
                        string ve = "SELECT id_classe from classe where nom_classe='" + Nom + "'";
                        var command = new MySqlCommand(ve, connection);
                        reader = command.ExecuteReader();
                        while (reader.Read())
                        {
                            idclasse = int.Parse(reader.GetValue(0).ToString());
                        }
                        reader.Close();
                        int nbreinscript = 0;
                        //verifions si  au moins un élève a été inscript dans cette classe
                        string ver = "SELECT count(id_inscription) as nbreinscript from inscription where id_classe='" + idclasse + "'";
                        command = new MySqlCommand(ver, connection);
                        reader = command.ExecuteReader();
                        while (reader.Read())
                        {
                            nbreinscript = int.Parse(reader.GetValue(0).ToString());
                        }
                        reader.Close();
                        if (nbreinscript == 0)
                        {
                            string requete = "DELETE FROM classe where nom_classe=@nom ";
                            Dictionary<string, object> parametre = new Dictionary<string, object>();
                            parametre.Add("@nom", Nom);
                            command = new MySqlCommand(requete, connection);
                            ...
                            {
                                string messag = "Classe supprimé avec succès. ";
                            ...
                            {
                                string messag = "Echec de suppression de la classe. Veuillez réessayer. ";
                        ...
                        {
                            string messag = "Echec de suppression de la classe. Au moins un élève à été inscript dans cette classe. ";
                            string titre = "Echec de Suppression";
                            // Programation des bouton de la boite de message
                            MessageBox.Show(messag, titre, MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    ...
                    {
                        string messag = "Nous nous sommes heurtés à un problème lors de la suppression de cette classe. "+ex;
                        string titre = "Echec de Suppression";
                        // Programation des bouton de la boite de message
                        MessageBox.Show(messag, titre, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
        ...
        private void NEW_CLASSE_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void NEW_CLASSE_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            reader.Close();
           int idsect = int.Parse(label5.Text);
            designDatagridviewSearch tabschool = new designDatagridviewSearch(tableaudonnees, idsect, comboBox1.Text);
            this.tableaudonnees.EnableHeadersVisualStyles = false;
            tableaudonnees.ColumnHeadersDefaultCellStyle.BackColor = Color.Blue;
            tableaudonnees.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            tabschool.Compteligne(tetedonnees, panel8, backPage1, precedentPage, suivantPage, dernierPage, btnPage1, btnPage2, btnPage3, btnPage4, btnPage5, 1, 15);
            ...
            // Respecter l'ordre d'appel des differentes méthode
            int numcont = int.Parse(btnPage1.Text);
            designDatagridviewSearch bv = new designDatagridviewSearch(tableaudonnees, idsect, comboBox1.Text);
            bv.Compteligne(tetedonnees, panel8, backPage1, precedentPage, suivantPage, dernierPage, btnPage1, btnPage2, btnPage3, btnPage4, btnPage5, numcont, 15);
            bv.affichDonneesdatagrid(tableaudonnees, numcont, 15);
            if(comboBox1.SelectedIndex == 0)
            {
                // Afficher toutes les classes si on séléctionne afficher toutes les sections
                designDatagridview tabschool2 = new designDatagridview(tableaudonnees);
                this.tableaudonnees.EnableHeadersVisualStyles = false;
                tableaudonnees.ColumnHeadersDefaultCellStyle.BackColor = Color.Blue;
                tableaudonnees.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                ...
                designDatagridview bv2 = new designDatagridview(tableaudonnees);
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            {
                string messag = "Aucune classe séléctionné pour la modification. ";
            ...
            else
            {
                ...
                Editclasse details = new Editclasse(valeur);
                details.ShowDialog();
            }
        }
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            ...
            if (tableaudonnees.Rows.Count == 0)
            {
                string messag = "Aucune classe séléctionné pour la suppression ";
                string titre = "Suppression";
                // Programation des bouton de la boite de message
                MessageBox.Show(messag, titre, MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        ...
        private void label13_Click(object sender, EventArgs e)
        {
            ...
            if (tableaudonnees.Rows.Count == 0)
            {
                string messag = "Aucune classe séléctionné pour plus de détails.";
            ...
            else
            {
                ...
                SearchId newde = new SearchId(nom);
                int valeur = newde.idLigne(0);
                detailsClasse details = new detailsClasse(valeur);
                details.ShowDialog();
            }
        }
