...
{
    public partial class NEW_INSCRIPTION : Form
    {
        // ---------------
        ...
        public class designDatagridview
        {
            ...
            public void affichDonnees(DataGridView datagridview)
            {
                ...
                string requete = "Select classe.id_classe,classe.nom_classe,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,inscription.matricule,inscription.id_classe,inscription.montinscription,inscription.montverse,inscription.reste From inscription inner join classe on inscription.id_classe=classe.id_classe inner join eleves on inscription.matricule=eleves.matricule where inscription.session=@session order by eleves.nom_eleve asc";
            ...
            public void affichDonneesdatagrid(DataGridView datagridview, int numbtn, int nbreligneParPage)
            {
                ...
                datagridview.AllowUserToAddRows = false;
                // couleur des entetes de colonnes
                string requete = "Select classe.id_classe,classe.nom_classe,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,inscription.matricule,inscription.id_classe,inscription.montinscription,inscription.montverse,inscription.reste,inscription.session From inscription inner join classe on inscription.id_classe=classe.id_classe inner join eleves on inscription.matricule=eleves.matricule where inscription.session=@session order by eleves.nom_eleve asc limit " + nbreligneParPage + " offset " + lignedebut + "";
                command = new MySqlCommand(requete, connection);
                Dictionary<string, object> para = new Dictionary<string, object>();
                para.Add("@session", Session);
                foreach(KeyValuePair<string,object> parametre in para)
            ...
            public int Compteligne(Label labeltete, Panel numpclob, Label backPage1, Label precedentPage, Label suivantPage, Label dernierPage, Label btnPage1, Label btnPage2, Label btnPage3, Label btnPage4, Label btnPage5, int numPageClick, int nbreLignePage)
            {
                ...
                if (nbrePage <= 1)
                {
                    ...
                    labeltete.Text = "1 / 1 page        " + nbreligne + " élève(s)  inscrit(s)";
                ...
                else
                {
                    ...
                    labeltete.Text = numPageClick + " / " + newNbrePage + " page(s)        " + nbreligne + " élève(s)  inscrit(s)";
        ...
        public class SearchId
        {
            ...
            // Accesseurs
            private string Matricule { set; get; }
            private string Session { set; get; }
            // Constructeur
            public SearchId(string matricule, string session)
            {
            ...
            public int idLigne(int idline)
            {
                ...
                connection.Open();
                string requete = "SELECT id_eleve,matricule FROM eleves where matricule=@matricule";
       ...
       // Methode d'affichage des section crée pour filtré la recherche des classes
        ...
        public class designDatagridviewSearch
        {
            ...
            public void affichDonnees(DataGridView datagridview)
            {
                ...
                if (Idsection == 0)
                {
                    requete = "Select classe.id_classe,classe.nom_classe,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,inscription.matricule,inscription.id_classe,inscription.montinscription,inscription.montverse,inscription.reste From inscription inner join classe on inscription.id_classe=classe.id_classe inner join eleves on inscription.matricule=eleves.matricule where inscription.session=@session AND (eleves.nom_eleve like @nom OR eleves.prenom_eleve like @prenom OR inscription.matricule like @matricule) order by eleves.nom_eleve asc";
                ...
                {
                    requete = "Select classe.id_classe,classe.nom_classe,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,inscription.matricule,inscription.id_classe,inscription.montinscription,inscription.montverse,inscription.reste From inscription inner join classe on inscription.id_classe=classe.id_classe inner join eleves on inscription.matricule=eleves.matricule where inscription.id_classe =@idsect AND inscription.session=@session AND (eleves.nom_eleve like @nom OR eleves.prenom_eleve like @prenom OR inscription.matricule like @matricule) order by eleves.nom_eleve asc";
            ...
            public void affichDonneesdatagrid(DataGridView datagridview, int numbtn, int nbreligneParPage)
            {
                ...
                if (Idsection == 0)
                {
                    requete = "Select classe.id_classe,classe.nom_classe,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,inscription.matricule,inscription.id_classe,inscription.montinscription,inscription.montverse,inscription.reste From inscription inner join classe on inscription.id_classe=classe.id_classe inner join eleves on inscription.matricule=eleves.matricule where inscription.session = @session  AND (eleves.nom_eleve like @nom OR eleves.prenom_eleve like @prenom OR inscription.matricule like @matricule) order by eleves.nom_eleve asc limit " + nbreligneParPage + " offset " + lignedebut + "";
                    parametre.Add("@session", Session);
                    parametre.Add("@nom", "%" + Nom + "%");
                    parametre.Add("@prenom", "%" + Nom + "%");
                    parametre.Add("@matricule", Nom + "%");
                ...
                {
                    requete = "Select classe.id_classe,classe.nom_classe,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,inscription.matricule,inscription.id_classe,inscription.montinscription,inscription.montverse,inscription.reste From inscription inner join classe on inscription.id_classe=classe.id_classe inner join eleves on inscription.matricule=eleves.matricule where inscription.id_classe =@idsect AND inscription.session = @session  AND (eleves.nom_eleve like @nom OR eleves.prenom_eleve like @prenom OR inscription.matricule like @matricule) order by eleves.nom_eleve asc limit " + nbreligneParPage + " offset " + lignedebut + "";
                    parametre.Add("@idsect", Idsection);
                    parametre.Add("@session", Session);
                    parametre.Add("@nom", "%" + Nom + "%");
                    parametre.Add("@prenom", "%" + Nom + "%");
            ...
            public int Compteligne(Label labeltete, Panel numpclob, Label backPage1, Label precedentPage, Label suivantPage, Label dernierPage, Label btnPage1, Label btnPage2, Label btnPage3, Label btnPage4, Label btnPage5, int numPageClick, int nbreLignePage)
            {
                ...
                {
                    // Une seul page trouvé
                    labeltete.Text = "1 / 1 page        " + nbreligne + " élève(s)  inscrit(s)  Classe : " + Nomsect + " ";
                    numpclob.Visible = false;
                    btnPage1.Visible = false;
                    btnPage2.Visible = false;
                    btnPage3.Visible = false;
                ...
                else
                {
                    ...
                    // Plusieurs pages trouvé
                    numpclob.Visible = true;
                    labeltete.Text = numPageClick + " / " + newNbrePage + " page(s)        " + nbreligne + " élève(s)  inscrit(s)  Classe : " + Nomsect + " ";
                    // remplissage de mon dictionnaire
                    for (int b = 1; b <= newNbrePage; b++)
                    {
                        numPage.Add(b);
        ...
        {
            AddInscription addinscript = new AddInscription(SessionActive(label11));
            addinscript.ShowDialog();
        }

        private void NEW_INSCRIPTION_Load(object sender, EventArgs e)
        {
            ...
            designDatagridview tabschool = new designDatagridview(tableaudonnees,session);
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            {
                string messag = "Aucune inscription séléctionné pour la modification. ";
            ...
            else
            {
                ...
                string session = label11.Text;
                EditInscription details = new EditInscription(nom,session);
                details.ShowDialog();
            }
        }
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            ...
            if (tableaudonnees.Rows.Count == 0)
            {
                string messag = "Aucune inscription séléctionné pour la suppression. ";
            ...
            else
            {
                string nom = (tableaudonnees.CurrentRow.Cells["matricule"].Value).ToString();
                string session = label11.Text;
                deletenscription details = new deletenscription(nom, session);
                details.ShowDialog();
            }
        }
        ...
        private void NEW_INSCRIPTION_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void label13_Click(object sender, EventArgs e)
        {
            ...
            if (tableaudonnees.Rows.Count == 0)
            {
                string messag = "Aucune inscription séléctionné pour les réçus. ";
                string titre = "Modification";
                // Programation des bouton de la boite de message
                MessageBox.Show(messag, titre, MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            else
            {
                string nom = (tableaudonnees.CurrentRow.Cells["matricule"].Value).ToString();
                string session = label11.Text;
                ListversementrPourecu liste = new ListversementrPourecu(nom, session);
                liste.ShowDialog();
            }
        ...
        private void comboBox2_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            int idsect = int.Parse(label6.Text);
            designDatagridviewSearch tabschool = new designDatagridviewSearch(tableaudonnees, idsect, comboBox2.Text,session2, textBox1.Text);
            this.tableaudonnees.EnableHeadersVisualStyles = false;
            tableaudonnees.ColumnHeadersDefaultCellStyle.BackColor = Color.Blue;
            tableaudonnees.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            tabschool.Compteligne(tetedonnees, panel8, backPage1, precedentPage, suivantPage1, dernierPage, btnPage1, btnPage2, btnPage3, btnPage4, btnPage5, 1, 15);
            ...
            // Respecter l'ordre d'appel des differentes méthode
            int numcont = int.Parse(btnPage1.Text);
            designDatagridviewSearch bv = new designDatagridviewSearch(tableaudonnees, idsect, comboBox2.Text,session2, textBox1.Text);
            bv.Compteligne(tetedonnees, panel8, backPage1, precedentPage, suivantPage1, dernierPage, btnPage1, btnPage2, btnPage3, btnPage4, btnPage5, numcont, 15);
            bv.affichDonneesdatagrid(tableaudonnees, numcont, 15);
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                designDatagridview tabschool2 = new designDatagridview(tableaudonnees,session);
                this.tableaudonnees.EnableHeadersVisualStyles = false;
                tableaudonnees.ColumnHeadersDefaultCellStyle.BackColor = Color.Blue;
                tableaudonnees.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                tabschool2.Compteligne(tetedonnees, panel8, backPage1, precedentPage, suivantPage1, dernierPage, btnPage1, btnPage2, btnPage3, btnPage4, btnPage5, 1, 15);
                // Connexion au serveur
                tabschool2.Connec();

                // Respecter l'ordre d'appel des differentes méthode
                int numcont2 = int.Parse(btnPage1.Text);
                designDatagridview bv2 = new designDatagridview(tableaudonnees,session);
                bv2.Compteligne(tetedonnees, panel8, backPage1, precedentPage, suivantPage1, dernierPage, btnPage1, btnPage2, btnPage3, btnPage4, btnPage5, numcont2, 15);
        ...
        private void suivantPage_Click_1(object sender, EventArgs e)
        {

        }

        private void suivantPage1_Click_1(object sender, EventArgs e)
        {
            //Changement dans mes label de numéro de page
            int suivant = int.Parse(btnPage5.Text) + 1;
            btnPage5.Text = suivant.ToString();
        ...
        private void suivantPage1_Click_2(object sender, EventArgs e)
        {
            //Changement dans mes label de numéro de page
            int suivant = int.Parse(btnPage5.Text) + 1;
            btnPage5.Text = suivant.ToString();
