...
{
    public partial class RECU_SCOLARITE : Form
    {
        // ---------------
        ...
        public class Maxcaisse
        {
            ...
            public void maxcaisse()
            {
                ...
                reader42.Close();
                string se = "select scolarite.session,scolarite.reste,scolarite.id_classe,scolarite.matricule,eleves.matricule,eleves.nom_eleve,eleves.prenom_eleve,classe.id_classe,classe.nom_classe from scolarite inner join eleves on scolarite.matricule=eleves.matricule inner join classe on scolarite.id_classe=classe.id_classe where scolarite.matricule=@matricule AND scolarite.session=@session";
