...
namespace TechnoSchool
{
    public partial class AddsessionForm : Form
    {
        ...
        // creation de la class d'insertion d'une nouvelle session
        public class InsertSession
        {
            ...
            private string Nomsession { get; set; }

            // Constructeur
            public InsertSession(string nom)
            {
                this.Nomsession = nom;
            ...
            {
                string requete = "UPDATE tabsession SET statut = 'desactiver'";
                ...
                if (command.ExecuteNonQuery() >= 0)
                {
                    ...
                    string req = "Select nom_session,count(nom_session) as nbresession from tabsession where nom_session=@nom";
                    Dictionary<string, object> para = new Dictionary<string, object>();
                    para.Add("@nom", Nomsession);
                    ...
                    if (nbreetabli < 1)
                    {
                        string requete2 = "INSERT INTO tabsession(nom_session,statut,date_creation,date_modification) values (@nom,@statut,@datecre,@datemod)";
                        ...
                        parametre.Add("@nom", Nomsession);
                        parametre.Add("@statut", "activer");
                        ...
                        {
                            string messag = "La session a été enregistrer avec succès. ";
                        ...
                        {
                            string messag = "Nous nous sommes heurtés à un problème lors de la création de la session. ";
                            string titre = "Insertion ";
                            // Programation des bouton de la boite de message
                    ...
                    {
                        string messag = "Il existe déjà une session ayant ce nom.";
        ...
        private void AddsessionForm_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                InsertSession newsession = new InsertSession(nom);
                int valuereturn = newsession.siDonneesValide;
                if(valuereturn == 1)
                {
                    nomsession.Text = "";
                }
