    ...
    public partial class Addsession : Form
    {
        ...
        public class designDatagridview
        {
            ...
            public void Connec()
            {
                ...
                {
                    string messag = "La connexion au serveur est impossible.. " + e.Message;
            ...
            public void affichDonnees(DataGridView datagridview)
            {
                ...
                datagridview.Columns[2].Name =  "Statut";
                ...
                string requete = "Select * from tabsession";
            ...
            public void affichDonneesdatagrid(DataGridView datagridview, int numbtn, int nbreligneParPage)
            {
                ...
                datagridview.AllowUserToAddRows = false;
                // couleur des entetes de colonnes
                string requete = "Select * from tabsession limit " + nbreligneParPage + " offset " + lignedebut + "";
                command = new MySqlCommand(requete, connection);
                command.Prepare();
                reader = command.ExecuteReader();
                datagridview.Rows.Clear();
                ...
                while (reader.Read())
                {
                    datagridview.Rows.Add(number.ToString(), "" + reader.GetValue(1).ToString(), reader.GetValue(2).ToString());
                    number++;
                }
                reader.Close();
                if(number - 1 < 1)
            ...
            public int Compteligne(Label labeltete, Panel numpclob, Label backPage1, Label precedentPage, Label suivantPage, Label dernierPage, Label btnPage1, Label btnPage2, Label btnPage3, Label btnPage4, Label btnPage5, int numPageClick, int nbreLignePage)
            {
                ...
                if (nbrePage <= 1)
                {
                    ...
                    labeltete.Text = "1 / 1 page        " + nbreligne + " session(s)  enregistré(s)";
                ...
                else
                {
                    ...
                    labeltete.Text = numPageClick + " / " + newNbrePage + " page(s)        " + nbreligne + " session(s)  enregistré(s)";
        ...
        public class SearchId
        {
            ...
            public int idLigne(int idline)
            {
                ...
                connection.Open();
                string requete = "SELECT id_session FROM tabsession where nom_session=@nom";
        ...
        public class deleteData
        {
            ...
            private void delete()
            {
                ...
                string messagconf = "Souhaitez-vous réellement supprimer la session " + Nom + " ?. ";
                ...
                if (result == DialogResult.Yes)
                {
                    connection = new MySqlConnection(connectionstring);
                    connection.Open();
                    // Verifions si une inscription a été effectuer dans cette session
                    // Si non alors impossible de d'avoir des scolarité et caisse dans cette session(suppression de la session validé)
                    // Si oui impossible de supprimer la session
                    int nbreinscript = 0;
                    string ve = "SELECT count(id_inscription) as nbreinscript from inscription where session='" + Nom + "'";
                    ...
                    if (nbreinscript == 0)
                    {
                        string requete = "DELETE FROM tabsession where nom_session=@nom";
                        Dictionary<string, object> parametre = new Dictionary<string, object>();
                        parametre.Add("@nom", Nom);
                        ...
                        {
                            string messag = "Session supprimé avec succès. ";
                        ...
                        {
                            string messag = "Echec de suppression de la session. Veuillez réessayer. ";
                    ...
                    {
                        string messag = "Echec de suppression de la session. Au moins une inscription à été effectuer dans cette session. ";
                        string titre = "Echec de Suppression";
                        // Programation des bouton de la boite de message
                        MessageBox.Show(messag, titre, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    }
        ...
        private void Addsession_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            AddsessionForm ajoutsession = new AddsessionForm();
            ajoutsession.ShowDialog();
        }
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            {
                string messag = "Aucune session séléctionné pour la modification. ";
            ...
            else
            {
                ...
                EditSession details = new EditSession(valeur);
                details.ShowDialog();
            }
        ...
        private void label13_Click(object sender, EventArgs e)
        {
            ...
            if (tableaudonnees.Rows.Count == 0)
            {
                string messag = "Aucune session séléctionné pour plus de détails. ";
            ...
            {
                detailsSession detail = new detailsSession();
                detail.ShowDialog();
            }
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            ...
            if (tableaudonnees.Rows.Count == 0)
            {
                string messag = "Aucune session séléctionné pour la suppression. ";
                string titre = "Suppression";
                // Programation des bouton de la boite de message
                MessageBox.Show(messag, titre, MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            ...
            {
                string nom = (tableaudonnees.CurrentRow.Cells["nom"].Value).ToString();
                deleteData supp = new deleteData(nom);
            }
